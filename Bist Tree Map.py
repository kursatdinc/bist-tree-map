...
fig=px.treemap(df,path=[px.Constant("Borsa İstanul"),"Sektör","Hisse"],values="Piyasa Değeri (mn $)", color="Renk",custom_data=["Getiri (%)","Sektör"],color_discrete_map={"(?)":"#262931","red":"red","indianred":"indianred","lightpink":"lightpink","lightgreen":"lightgreen","lime":"lime","green":"green"})
...
offline.plot(fig,filename="/Users/krtdnc/Desktop/Python Projeler/Bist Tree Map/Treemap.html")